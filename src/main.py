...
from src.routes import auth, categories, products, skus, invoices, catalog, reserve, events
...
app.include_router(catalog.router)   # Этап 7: US-B2B-07
app.include_router(reserve.router)   # Этап 8: US-B2B-08
app.include_router(events.router)    # Этап 9: US-B2B-09
